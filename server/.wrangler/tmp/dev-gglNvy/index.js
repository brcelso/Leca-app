...
// .wrangler/tmp/bundle-UVKw3s/checked-fetch.js
    ...
    try {
      ...
      if (path === "/api/debug" && request.method === "GET") {
        ...
        return new Response(JSON.stringify({
          ...
          stats,
          recent_logins: [],
          // Privacy: Never leak other users
